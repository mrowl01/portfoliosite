		...
		return(
			...
			<div  >
				<div class="card mx-auto" >
				  <img class = 'img-fluid'src="/static/yelp.png" alt="..." style = {{width:'inherit', display:'flex', justifyContent:'center', overflow:'hidden'}} />
				  <div class="card-body" >
				    ...
				    <a href="https://face-recognition0.herokuapp.com/" class="btn btn-primary btn-sm" style = {{marginBottom:'2%'}}>Live</a>
				    <br/>
				    ...
				    <br/>
				    <a style = {{marginTop:'1.6%', marginBottom:'2%'}}href="https://github.com/mrowl01/FaceRecognitionBackEnd" class="btn btn-primary btn-sm">Github Back-End</a>
				  </div>
				</div>
				<div class="card mx-auto" >
				  <img class = 'img-fluid' src="/static/yelp.png" alt="..."  style = {{width:'inherit', display:'flex', justifyContent:'center', overflow:'hidden'}} />
